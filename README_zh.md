...
| id | 目标 | 根因（简述） |
|---|---|---|
| `python.typing.override.backport` | `typing.override` | MUSA 厂商栈只有 CPython 3.10，而 Megatron 0.19 的 `training/models/{gpt,hybrid}.py` 导入 3.12 才有的 `typing.override`；解释器缺失时绑定 `typing_extensions.override`，导入即可通过 |
